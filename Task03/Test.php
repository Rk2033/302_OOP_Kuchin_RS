...
function runTest()  
{
    ...
    $student1->setLastName("Кучин")->setFirstName("Руслан")->setFaculty("ФИиИТ")->setCourse(3)->setGroup(302);

    $student2 = new Student();
    $student2->setLastName("Андрей")->setFirstName("Кирилленко")->setFaculty("ПФМИ")->setCourse(5)->setGroup(123);
